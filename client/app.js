...
import { firebaseConfig } from './firebase-config.js';
    ...
    const PAYMENT_METHODS = {
      Cash: { icon: '💵', color: '#ff8c69', keywords: ['cash', 'physical money', 'hard cash', 'notes'] },
      Card: { icon: '💳', color: '#6ee7ff', keywords: ['card', 'credit', 'debit', 'visa', 'mastercard', 'pos', 'swipe'] },
      UPI: { icon: '📱', color: '#a78bfa', keywords: ['upi', 'phonepe', 'gpay', 'paytm', 'google pay', 'scanner', 'bhim', 'phone pay'] },
      Bank: { icon: '🏦', color: '#fbbf24', keywords: ['bank', 'net banking', 'transfer', 'neft', 'imps', 'cheque', 'rtgs'] },
    };
    ...
    function detectPaymentMethod(text) {
      ...
      // Specific lookups for UPI / Cards / Cash
